...
namespace Semi_automatic_trace.Services
{
    public class Visualise
    {
        ...
        public void VisualTraces2(Document doc, List<ElectricalSystemElements> tracingPanel)
        {

            foreach (ElectricalSystemElements electricalSystemElements in tracingPanel)
            {
